...
For **Cursor**, run the MCP server (`./scripts/run_mcp_http.sh`; see [docs/CHROMA_AND_STACK.md](docs/CHROMA_AND_STACK.md#running-the-mcp-http-server)) and connect to `http://127.0.0.1:8765`. Call `list_silos` before trusting retrieval.
