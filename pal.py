...
def install_command(
    ...
    if env_file.exists() and not force:
        print(f"env file:  {env_file} (already exists — use --force to overwrite)")
        if not any(ln.startswith("LLMLIBRARIAN_EMBEDDING") for ln in env_file.read_text().splitlines()):
            print(_IDLE_HINT)
    else:
